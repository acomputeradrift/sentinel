...
class RoomListSyntheticRenderingTest(unittest.TestCase):
    ...
    def test_synthetic_rows_use_orientation_specific_coordinates(self):
        ...
        # Rows are inset inside the shell; extra hit shrink narrows row targets so the host list can be clicked in the gutters.
        self.assertIn("data-p-left='18'", attrs)
        self.assertIn("data-l-left='18'", attrs)
    ...
    def test_page_payload_emits_scoped_synthetic_source_rows(self):
        ...
        self.assertIn("data-p-left='18'", html)
        self.assertIn("data-l-left='18'", html)
