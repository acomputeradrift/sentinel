...
class PageLinkRenderingRegressionTest(unittest.TestCase):
    def test_page_link_overlay_renders_only_for_enabled_links(self):
        ...
        app_ui = {
            ...
            "zoomControls": {"enabled": True, "placement": {"anchor": "left-control-space", "alignTopToRtiCanvas": True, "centerHorizontallyInControlSpace": True}, "buttons": {"decrease": "-", "reset": "100%", "increase": "+"}, "zoom": {"defaultPercent": 100, "maxPercent": 200, "stepPercent": 10}},
