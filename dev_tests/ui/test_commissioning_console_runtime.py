...
class CommissioningConsoleRuntimeTest(unittest.TestCase):
    ...
    def test_commissioning_ui_drives_core_mvp_flow(self):
        ...
        expect(page.get_by_test_id("commission-topline")).to_be_visible()
        expect(page.get_by_test_id("commission-topline")).to_contain_text("Client A -> Project 1 -> TEST - System Manager v11.3.apex")
