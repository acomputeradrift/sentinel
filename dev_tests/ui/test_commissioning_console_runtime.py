...
"""
        ...
        tabs = page.locator("nav.sidenav .tab")
        expect(tabs).to_have_count(7)
        expect(tabs.nth(0)).to_have_text("File")
        expect(tabs.nth(1)).to_have_text("Tech Links")
        expect(tabs.nth(2)).to_have_text("Commissioning")
        expect(tabs.nth(3)).to_have_text("Diagnostics")
