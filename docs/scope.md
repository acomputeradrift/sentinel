...
## In Scope
1. Generating a project-specific JSON file from a project's `.apex` file using the `project_structure.json` template, and generating the user testing interface from that project-specific JSON using the `app_ui_structure.json` template.
